def search(df, search_params):
    """
    Searches for cells in the DataFrame that match the given search parameters.
    ...
    Returns:
        pandas.DataFrame: A DataFrame containing the cells that match the search terms.
    """
